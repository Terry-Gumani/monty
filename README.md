...
Welcome to the Monty Bytecode Interpreter. This interpreter was built in the C language.
interpreter can be run as either a stack (LIFO) or queue (FIFO). Mode can be switched mid-script. The interpreter can handle a variety of Monty opcodes.
...
```
$ git clone https://github.com/Terry-Gumani/monty.git
```
